...
namespace vr
{
namespace IVRTrackedCamera_006
{
...
public:
	...
	virtual EVRTrackedCameraError GetCameraIntrinsics( TrackedDeviceIndex_t nDeviceIndex, uint32_t nCameraIndex, EVRTrackedCameraFrameType eFrameType, HmdVector2_t *pFocalLength, HmdVector2_t *pCenter ) = 0;

	virtual EVRTrackedCameraError GetCameraProjection( TrackedDeviceIndex_t nDeviceIndex, uint32_t nCameraIndex, EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, HmdMatrix44_t *pProjection ) = 0;
	...
	* guarantees a rectangle where all pixels are valid. */
	...
	virtual void SetCameraTrackingSpace( ETrackingUniverseOrigin eUniverse ) = 0;
	virtual ETrackingUniverseOrigin GetCameraTrackingSpace( ) = 0;
};
