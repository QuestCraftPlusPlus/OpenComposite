...
protected:
	...
	void CheckCreateSwapChain(int width, int height, vr::EColorSpace c_space, GLuint format);
	 ...
	 * up using this.
	 */
	static GLuint NormaliseFormat(vr::EColorSpace c_space, GLuint rawFormat);
